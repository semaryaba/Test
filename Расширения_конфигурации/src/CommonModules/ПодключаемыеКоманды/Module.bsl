...
Процедура ДополнитьФорму(Форма) Экспорт
	//{{Рябов С.В. дополнить форму полем контактное лицо
	ИмяФормы = Форма.ИмяФормы;
...
Процедура ДобавитьПолеКонтактноеЛицоВГруппаШапкаПраво(Форма)
	//{{Рябов С.В. дополнить форму полем контактное лицо           
	ПолеВвода = Форма.Элементы.Добавить("РСВ_КонтактноеЛицо", Тип("ПолеФормы"), Форма.Элементы.ГруппаШапкаПраво);
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПутьКДанным = "Объект.РСВ_КонтактноеЛицо";
	//}}
КонецПроцедуры

Процедура ВставитьПолеКонтактноеЛицоНаформуПередСуммаДокумента(Форма)
	//{{Рябов С.В. дополнить форму полем контактное лицо
	ПолеВвода = Форма.Элементы.Вставить("РСВ_КонтактноеЛицо", Тип("ПолеФормы"),, Форма.Элементы.СуммаДокумента);
	ПолеВвода.Вид = ВидПоляФормы.ПолеВвода;
	ПолеВвода.ПутьКДанным = "Объект.РСВ_КонтактноеЛицо";
	//{{Рябов С.В. дополнить форму полем контактное лицо
КонецПроцедуры
